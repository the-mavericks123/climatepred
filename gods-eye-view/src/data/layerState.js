...
export function normalizeLayerState(candidate) {
  ...
  if (!enabled.has('flights') && options.flights) options.flights.selectedFlightsTrackingId = null;
  if (!enabled.has('military') && options.flights) options.flights.selectedMilitaryTrackingId = null;
  if (!enabled.has('satellites') && options.satellites) options.satellites.selectedSatTrackingId = null;
